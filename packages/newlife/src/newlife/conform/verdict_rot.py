...
DEPENDS_ON: dict[str, tuple[str, ...]] = {
    ...
    "fourteenth": ("conform/judgment.py",
                   "conform/cross_runtime_verdict.py", "core/harness.py", "core/runtime.py",
    ...
    "fifteenth": ("conform/judgment.py",
                   "conform/foreign_process_verdict.py",
    ...
    "sixteenth": ("conform/judgment.py",
                   "conform/external_package_verdict.py",
                  "adapters/process_bigraph/foreign.py",
                  "adapters/process_bigraph/bare_control.py",
                  "adapters/process_bigraph/lowering.py",
                  "mechanisms/foreign_monod/"),
    # 第十七个背后是 LP 求解器：接线表、降级表、代写声明都在依赖面上
    "seventeenth": ("conform/judgment.py",
                   "conform/solver_backed_verdict.py",
                    "adapters/process_bigraph/foreign.py",
                    "adapters/process_bigraph/bare_control.py",
                    "adapters/process_bigraph/lowering.py",
                    "mechanisms/foreign_dfba/"),
    # 第十八个推导权限声明：动推导器或三份手写声明都要重跑
    "eighteenth": ("conform/judgment.py",
                   "conform/derive_authority_verdict.py",
