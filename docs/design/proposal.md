...
- **日期**：2026-08-31　**状态**：v0.8（v0.1a 与 v0.1b 均已判定：H1 支持，`compatible_for_frozen_slices_v1_lowered` 与 `staging_declarable_for_frozen_slices`——见 §7 里程碑表与修订记录；下一步：v0.2 gate——第一个世界问题（Parworlds 冻结研究 000/001 候选）
