---
name: Bug report
about: Something newlife did, or refused to do, that you think is wrong
---
...
**Where the question is** (paste the output; it says the stage, what blocks and what comes next)

```
$ newlife status questions/<slug>
```

**What you said to your AI, or the command you ran**
